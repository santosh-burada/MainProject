...
class Student:
    def __init__(self, rootwindow):
        ...
        # BackGround Details
        img = Image.open(r"Images\studentdetails.jpg")
        ...
        img1 = Image.open(r"Images\StudentFormImage.png")
        ...
        # Image in Student Details Frame
        Search_image = Image.open(r"Images\SearchImage.png")
    ...
    def Capture_Photos(self):
        ...
        try:
            ...
            parent_dir = r"InputData"
            path = os.path.join(parent_dir, directory)
            os.mkdir(path)
            directory = "InputData/" + str(self.var_stdId.get())
