...
class FaceRecognition:
    ...
    def __init__(self, rootwindow):
        ...
        student = Image.open(r"Images\studnetDetailsImage.png")
        ...
        # Training Button
        TrainDataimg = Image.open(r"Images\attendeceExportImage.jpg")
        ...
        FaceRecognitionImage = Image.open(
            r"Images\FaceRecognitionImage.jpg")
        ...
        ComputerEye = Image.open(r"Images\Computer Eye.png")
